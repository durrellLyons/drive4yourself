<section class='mission' id='missionAndPurpose'>
    <div class='content'>
        <h2>MISSION STATEMENT <br> & PURPOSE</h2>
        <p>
...
<section class="about" id="about">
    <article role="article" class="content">
        ...
        <p class="p-note">
            ...
            <p>
                My name is Terrence McLaurin and I am an entrepreneur.
                I began driving for Uber in 2017 and have already seen a tremendous change in how my life works differently
                being my own boss.
            ...
            <p>
                My first encounters with Uber were actually before the UberX and other levels were launched.
                Uber was previously a "Black-Car" service, but regular patrons like you and I, could use the app the same
                way we do today and request a ride.
                I became interested in what Uber had to offer and was very intrigued with the benefits and rewards I would
                see DAILY partnering with the company.
            </p>
            
            <p>
                I immediately filled out an application, got approved and instantly started making money.
                I was approved in less than a week and began changing my life.
                Now I work when I want to, play when I want to, eat when I want to, for as long as I want to.
                The best part of all, I GET PAID WHEN I WANT TO!!!!!
                Instant pay has done wonders in my life.
